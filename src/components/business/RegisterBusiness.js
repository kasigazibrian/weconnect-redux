...
class BusinessRegistration extends React.Component {
  ...
  render(){
    ...
    return (
      <BusinessForm handleSubmit={this.handleSubmit} handleChange={this.handleChange} btnText={"Register"}/>
    );
  }
}
...
export default connect(mapStateToProps, { createBusiness })(BusinessRegistration)
