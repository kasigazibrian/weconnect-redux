import {FETCH_BUSINESSES, BUSINESS_ACTION_FAILED,
  INTERNAL_SERVER_ERROR, SEARCH_BUSINESSES } from "./actionTypes";
...
export const searchBusinesses = (businessName, category, location) => (dispatch) => {
