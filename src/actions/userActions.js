...
export const signUp = user => dispatch => {
  axios
    .post(`${Config.API_BASE_URL}/api/v2/auth/register`, JSON.stringify(user), {
...
export const logIn = userCredentials => dispatch => {
  axios
    .post(
      `${Config.API_BASE_URL}/api/v2/login`,
...
export const getUserProfile = token => dispatch => {
  ...
  axios
    .get(`${Config.API_BASE_URL}/api/v2/auth/register`, {
      headers: { "Content-Type": "application/json" }
    })
    .then(response => {
      return dispatch({
...
export const changePassword = (newPassword, token) => dispatch => {
  ...
  axios
    .post(
      `${Config.API_BASE_URL}/api/v2/auth/reset-password`,
...
export const logOut = () => dispatch => {
  ...
  axios
    .post(`${Config.API_BASE_URL}/api/v2/auth/logout`, {
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json"
      }
